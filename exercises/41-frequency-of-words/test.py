...
@pytest.mark.it('The function words_output must exist')
def test_function_existence(capsys, app):
    assert app.words_output


@pytest.mark.it('The function should return the expected output')
def test_expected_output(capsys, app):
    assert app.words_output("New to Python or choosing between Python 2 and Python 3? Read Python 2 or Python 3.") == "2:2 3.:1 3?:1 New:1 Python:5 Read:1 and:1 between:1 choosing:1 or:2 to:1"